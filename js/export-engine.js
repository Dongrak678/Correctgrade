...
class ExportEngine {
  ...
  downloadTemplate(type) {
    ...
    switch (type) {
      ...
      case 'students':
        content += "student_id,prefix,name,number,grade_level,room,advisor,phone\r\n";
        content += '50101,นาย,กิตติศักดิ์ พากเพียร,1,ม.4,1,ครูสมชาย ใจดี,090-123-4567\r\n';
        content += '50102,นางสาว,ศิริพร สุขเกษม,2,ม.4,1,ครูสมชาย ใจดี,090-234-5678\r\n';
        content += '60205,นาย,ธนพล มุ่งมั่น,5,ม.5,2,ครูวรรณา รักเรียน,090-345-6789\r\n';
